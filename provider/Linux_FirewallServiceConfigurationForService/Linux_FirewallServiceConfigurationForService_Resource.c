...
// GetInstance()
// ----------------------------------------------------------------------------
CMPIStatus Linux_ServiceConfigurationForService_GetInstance( const CMPIBroker *broker, const CMPIContext *context, const CMPIObjectPath *reference,    
    ...
    status = Linux_ServiceConfigurationForService_getResource(broker, context, reference, resource);
    ...
    status = Linux_ServiceConfigurationForService_GetInstanceFromResource(broker, context, reference, properties, resource, instance);
...
CMPIStatus Linux_ServiceConfigurationForService_GetInstanceFromResource( const CMPIBroker *broker, const CMPIContext *context, 
    ...
    *instance = CMNewInstance( broker, op, &status);
	...
	Linux_ServiceConfigurationForService_SetInstanceData(broker, *instance, resource);
...
bool Linux_ServiceConfigurationForService_EqualsObjectPath 
	...
	for (i = 0; i < count; i++) {
        ...
        if (!Linux_ServiceConfigurationForService_Compare_CMPIData( broker, &data1, &data2 )) {
        	return false;
        }
	}
...
bool Linux_ServiceConfigurationForService_Compare_CMPIData 
    ...
    if (data1->type == CMPI_ref) {
    	return Linux_ServiceConfigurationForService_EqualsObjectPath( broker, data1->value.ref, data2->value.ref);
...
bool Linux_ServiceConfigurationForService_Validate(const CMPIBroker *broker, 
	...
	if (!Linux_ServiceConfigurationForService_EqualsObjectPath(broker, op1, op2)) {
