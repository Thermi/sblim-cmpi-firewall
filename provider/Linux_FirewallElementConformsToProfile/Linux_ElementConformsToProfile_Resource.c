...
/* 
 * 	Query CIMOM for enum of Linux_FirewallRegisteredProfile & Linux_FirewallService
 * 	Instantiate Linux_FirewallElementConformsToProfile & populate the references with 
 ...
 * 	Samkannan:
 *  	Query List of objects : FirewallRegisteredProfile & FirewallService using: 
 *
