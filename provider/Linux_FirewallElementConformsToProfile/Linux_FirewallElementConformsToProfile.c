...
// ----------------------------------------------------------------------------
CMPIStatus Linux_FirewallElementConformsToProfile_EnumInstanceNames(
...
// ----------------------------------------------------------------------------
CMPIStatus Linux_FirewallElementConformsToProfile_EnumInstances(
            CMPIInstanceMI * self,               /* [in] Handle to this provider (i.e. 'self'). */
            const CMPIContext * context,         /* [in] Additional context info, if any. */
            const CMPIResult * results,          /* [out] Results of this operation. */
            const CMPIObjectPath * reference,    /* [in] Contains target namespace and classname. */
...
// ----------------------------------------------------------------------------
CMPIStatus Linux_FirewallElementConformsToProfile_GetInstance(
            CMPIInstanceMI * self,               /* [in] Handle to this provider (i.e. 'self'). */
            const CMPIContext * context,         /* [in] Additional context info, if any. */
            const CMPIResult * results,          /* [out] Results of this operation. */
...
// ----------------------------------------------------------------------------
CMPIStatus Linux_FirewallElementConformsToProfile_ModifyInstance(
            CMPIInstanceMI * self,               /* [in] Handle to this provider (i.e. 'self'). */
            const CMPIContext * context,         /* [in] Additional context info, if any. */
            const CMPIResult * results,          /* [out] Results of this operation. */
            const CMPIObjectPath * reference,    /* [in] Contains the target namespace, classname and object path. */
...
// ----------------------------------------------------------------------------
CMPIStatus Linux_FirewallElementConformsToProfile_CreateInstance(
            CMPIInstanceMI * self,               /* [in] Handle to this provider (i.e. 'self'). */
            const CMPIContext * context,         /* [in] Additional context info, if any. */
            const CMPIResult * results,          /* [out] Results of this operation. */
            const CMPIObjectPath * reference,    /* [in] Contains the target namespace, classname and object path. */
...
// ----------------------------------------------------------------------------
CMPIStatus Linux_FirewallElementConformsToProfile_DeleteInstance(
            CMPIInstanceMI * self,               /* [in] Handle to this provider (i.e. 'self'). */
            const CMPIContext * context,         /* [in] Additional context info, if any. */
            const CMPIResult * results,          /* [out] Results of this operation. */
            const CMPIObjectPath * reference)    /* [in] Contains the target namespace, classname and object path. */
...
// ----------------------------------------------------------------------------
CMPIStatus Linux_FirewallElementConformsToProfile_ExecQuery(
            CMPIInstanceMI * self,               /* [in] Handle to this provider (i.e. 'self'). */
            const CMPIContext * context,         /* [in] Additional context info, if any. */
            const CMPIResult * results,          /* [out] Results of this operation. */
...
// first loaded.
// ----------------------------------------------------------------------------
CMPIStatus Linux_FirewallElementConformsToProfile_Initialize(
            CMPIInstanceMI * self,               /* [in] Handle to this provider (i.e. 'self'). */
            const CMPIContext * context)         /* [in] Additional context info, if any. */
{
    CMPIStatus status = { CMPI_RC_OK, NULL };
...
// first loaded.
// ----------------------------------------------------------------------------
CMPIStatus Linux_FirewallElementConformsToProfile_AssociationInitialize(
...
// ----------------------------------------------------------------------------
static CMPIStatus Linux_FirewallElementConformsToProfile_Cleanup(
            CMPIInstanceMI * self,               /* [in] Handle to this provider (i.e. 'self'). */
            const CMPIContext * context,         /* [in] Additional context info, if any. */
...
/// Perform any necessary cleanup immediately before this provider is unloaded.
/// ----------------------------------------------------------------------------
static CMPIStatus Linux_FirewallElementConformsToProfile_AssociationCleanup(
	CMPIAssociationMI * self,	/** [in] Handle to this provider (i.e. 'self'). */
	const CMPIContext * context,		/** [in] Additional context info, if any. */
	CMPIBoolean terminating) {
 ...
 * (specfied objectpath) using this FirewallElementConformsToProfile association class.
 ...
 *  eg:in FirewallElementConformsToProfile,
 ...
 *  if (assocClass != NULL) check to make sure that its = Linux_FirewallElementConformsToProfile or parent 
 * 
 ...
 *  
 */
static CMPIStatus Linux_FirewallElementConformsToProfile_AssociatorNames(
 ...
 *  
 */
static CMPIStatus Linux_FirewallElementConformsToProfile_Associators(
 ...
 *  if (assocClass != NULL) check to make sure that its = Linux_FirewallElementConformsToProfile or parent
 *  
 * Result type is ObjectPath of FirewallElementConformsToProfile instance 
 *  
 * Arguments:
 * CMPIAssociationMI * self			-[in] Handle to this provider (i.e. 'self'). 
 * const CMPIContext * context		-[in] Additional context info, if any.
 ...
 *  
 */
static CMPIStatus Linux_FirewallElementConformsToProfile_ReferenceNames(
 ...
 * else the data does not match filter & return nothing
 * 
 * Result type is FirewallElementConformsToProfile 
 *  
 * Arguments: 
 * CMPIAssociationMI * self			-[in] Handle to this provider (i.e. 'self'). 
 * const CMPIContext * context		-[in] Additional context info, if any.
 ...
 *  
 */
static CMPIStatus Linux_FirewallElementConformsToProfile_References(
	CMPIAssociationMI * self, const CMPIContext * context, const CMPIResult * results, const CMPIObjectPath * reference,
...
// ============================================================================
CMInstanceMIStub(Linux_FirewallElementConformsToProfile_, Linux_FirewallElementConformsToProfileProvider, _BROKER, Linux_FirewallElementConformsToProfile_Initialize(&mi, ctx));
CMAssociationMIStub(Linux_FirewallElementConformsToProfile_, Linux_FirewallElementConformsToProfileProvider, _BROKER, Linux_FirewallElementConformsToProfile_AssociationInitialize(&mi, ctx));
